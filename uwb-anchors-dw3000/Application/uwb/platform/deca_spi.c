...
//    while(__HAL_SPI_GET_FLAG(&UWB_SPI, SPI_FLAG_TXE) == RESET)//Verify that the transmit was ended
//    {
//    }
//
...
//        while(__HAL_SPI_GET_FLAG(&UWB_SPI, SPI_FLAG_TXE) == RESET)
//        {
//        }
//
//        UWB_SPI.Instance->RXDR=0;
//
...
//        while(__HAL_SPI_GET_FLAG(&UWB_SPI, SPI_FLAG_RXNE) == RESET)
//        {
//        }
//
//        (*readBuffer++) = UWB_SPI.Instance->RXDR;  //copy data read form (MISO)
//    }
